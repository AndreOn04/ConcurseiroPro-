    ...
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-10 flex flex-col items-center gap-6 w-full max-w-md">
        ...
        <div className="flex flex-col items-center gap-1">
          <span className="text-3xl font-extrabold text-indigo-400">ConcurseiroPro</span>
          <p className="text-slate-400 text-sm">Sua plataforma gratuita de estudos</p>
        </div>
        ...
        {etapa === "verificar" ? (
          <div className="flex flex-col gap-5 w-full">
            <div className="text-center">
              ...
              <p className="text-indigo-400 text-sm font-medium mt-1">{emailPendente}</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                onClick={() => { setEtapa("form"); setErro(""); setSucesso(""); }}
            ...
            <div className="flex w-full bg-slate-800 rounded-lg p-1">
              <button
                ...
                className={`flex-1 py-2 rounded-md text-sm font-medium transition-colors ${
                  aba === "entrar" ? "bg-indigo-600 text-white" : "text-slate-400 hover:text-white"
                }`}
              >
                Entrar
              </button>
              <button
                ...
                className={`flex-1 py-2 rounded-md text-sm font-medium transition-colors ${
                  aba === "cadastrar" ? "bg-indigo-600 text-white" : "text-slate-400 hover:text-white"
                }`}
              >
                Cadastrar
              </button>
